...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference('Participant.count') do
      post participants_url, params: { participant: { interview_id: @participant.interview_id, name: @participant.name, role: @participant.role } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { interview_id: @participant.interview_id, name: @participant.name, role: @participant.role } }
