...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post interviews_url, params: { interview: { endTime: @interview.endTime, interviewDate: @interview.interviewDate, participants: @interview.participants, startTime: @interview.startTime, title: @interview.title } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { endTime: @interview.endTime, interviewDate: @interview.interviewDate, participants: @interview.participants, startTime: @interview.startTime, title: @interview.title } }
